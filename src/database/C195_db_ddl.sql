...
-- create a query to check check the cancceled appointments
SELECT * FROM appointments WHERE Start < NOW() AND End < NOW();

--  delete the
DELETE FROM appointments WHERE Start < NOW() AND End < NOW();


-- create a query to check overlapping appointments in that perticular time and date
SELECT * FROM appointments WHERE Start BETWEEN '2021-03-01 00:00:00' AND '2021-03-01 23:59:59';
