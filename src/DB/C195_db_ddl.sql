...
-- start '2021-03-01 00:00:00' end '2021-03-01 23:59:59' 
-- create check if there is any appointments within the user's time given above for that day
-- if there is, then display the appointment
-- if there is not, then display "No Appointments Today"
-- if there is, then display the appointment
-- if there is not, then display "No Appointments Today"
SELECT * FROM appointments WHERE Start >= '2021-03-01 00:00:00' AND End <= '2021-03-01 23:59:59';